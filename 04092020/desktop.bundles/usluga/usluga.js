...
/* begin: ../../common.blocks/order-block/order-block.js */
modules.define('order-block', ['i-bem-dom'], function(provide, bemDom) {
...
/* end: ../../common.blocks/order-block/order-block.js */
/* begin: ../../common.blocks/work-examples/work-examples.js */
modules.define('work-examples', ['i-bem-dom', 'jquery'], function(provide, bemDom, $) {
  // определяем jQuery для pushy
  jQuery = $;
  /* borschik:include:../../node_modules/swiper/dist/js/swiper.js */
  ...
  $(document).ready(function () {
    ...
    var swiper = new window.Swiper('.work-examples__carusel', {
      slidesPerView: 4,
      spaceBetween: 10,
      pagination: {
        el: '.work-examples__swiper-pagination',
        clickable: true,
      },
      breakpoints: {
        1024: {
    ...
    if (window.matchMedia('(max-width: 640px)').matches === false) {
        $(".swiper-slide", '.work-examples__wrapp').mouseenter( function(e){
...
/* end: ../../common.blocks/work-examples/work-examples.js */
/* begin: ../../common.blocks/printing-examples/printing-examples.js */
...
/* end: ../../common.blocks/printing-examples/printing-examples.js */
