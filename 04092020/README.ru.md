#Sava depended [ВАЖНО]
На Windows 10 не срабатывают скрипты в node_modules

Библиотека jquery-form-validator:
jquery.form-validator.js: на 17 строку добавить код: var jQuery = $; //sava

Библиотека swiper:
swiper.js: перед return Swiper, необходимо написать код: window.Swiper = Swiper;

Библиотека jquery-mask-plugin:
jquery.mask.js: на строку 53 добавить: var $ = jQuery; //sava
